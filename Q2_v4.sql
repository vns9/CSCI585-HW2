...
/*
  ...
  - We make use CTE (Common Table Expression) here. CTEs are temporary table structures. CTE (Common Table Expression) is a feature in Oracle 19c that allows you to define a temporary named result set that can be used within the context of a single SQL statement.
